...
def main():
    ...
    parser.add_argument("--extract_dynamic", action="store_true", help="Write only DYNAMIC lines and rename their labels to __TSO0, __TSO1, etc.")
    ...
    try:
        c.convert_3do23d(
            ...
            extract_dynamic=args.extract_dynamic
        )
